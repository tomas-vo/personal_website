...
const translations = {
  es: {
    ...
    exp1_b1: "Coordino flujos de onboarding técnico y brindo soporte continuo a usuarios, trabajando directamente con equipos de gestión en Estados Unidos en inglés, portugués y español.",
    exp1_b2: "Lidero tres sesiones grupales semanales multifuncionales, coordinando distintos equipos y adaptando la comunicación a diferentes necesidades de usuario.",
    exp1_b3: "Gestiono el ciclo completo de seguimiento y documentación de las cohortes de onboarding: registros de avance, planes de ejecución, resúmenes de mentoría y datos de CRM.",
    exp1_b4: "Identifico problemas recurrentes de flujo y comunicación, y desarrollo documentación y FAQ proactivas, contribuyendo a una mejora del 20% en la precisión y entrega del onboarding.",
    exp1_b5: "Resuelvo problemas de usuarios y de flujo de trabajo, adaptándome rápidamente a cambios en software, procesos y prioridades operativas.",
    ...
    exp2_b1: "Construyo un emprendimiento internacional de importación y e-commerce de repuestos automotrices, diseñado para automatizar de principio a fin el proceso de abastecimiento de productos desde Brasil y su venta en Chile.",
    exp2_b2: "Diseñé e implementé flujos de trabajo automatizados que conectan proveedores, datos de productos, inventario, precios y Shopify usando n8n, REST APIs, Google Sheets, herramientas de IA e infraestructura en la nube.",
    exp2_b3: "Construí automatizaciones para ingesta, clasificación, traducción, fijación de precios, publicación y verificación de inventario de productos, integrando reglas de negocio con fuentes de datos externas.",
    exp2_b4: "Desarrollé verificación automática de stock activada por nuevos pedidos, para prevenir sobreventa y mejorar la confiabilidad de los pedidos.",
    exp2_b5: "Despliego y mantengo un entorno de automatización autoalojado en Ubuntu/DigitalOcean usando Docker, Caddy, Cloudflare DNS y SSL automatizado.",
    exp2_b6: "Integré la API Admin de Shopify y resolví problemas de autenticación, permisos, dependencias de datos y ejecución de flujos, aprendiendo e implementando nuevas tecnologías de forma independiente.",
    ...
    exp3_b1: "Brindé atención a huéspedes internacionales en inglés y portugués además de español, resolviendo solicitudes de servicio y problemas de comunicación en un entorno de ritmo acelerado.",
    exp3_b2: "Gestioné múltiples prioridades simultáneas manteniendo atención al detalle, profesionalismo y apego a los procedimientos operativos y de seguridad.",
    exp3_b3: "Me adapté rápidamente a necesidades cambiantes de los huéspedes y a requerimientos operativos sensibles al tiempo.",
    ...
    exp4_b1: "Fui el enlace operativo y multilingüe principal de un director regional, coordinando comunicaciones, logística, documentación y procesos organizacionales en un entorno internacional.",
    exp4_b2: "Gestioné estructuras de apoyo, recursos y logística operativa para una comunidad multicultural de más de 150 voluntarios internacionales.",
    exp4_b3: "Actué como punto de contacto principal para resolver cuellos de botella lingüísticos, operativos y de flujo de trabajo, apoyando la adopción de procedimientos organizacionales.",
    exp4_b4: "Realicé auditorías diarias de alto volumen sobre información de desempeño y cumplimiento, manteniendo precisión y alineación con los estándares de la organización.",
    exp4_b5: "Coordiné la comunicación entre stakeholders de múltiples países y trasfondos culturales, lo que exigió fuerte priorización, organización y resolución de problemas.",
    cv_title: "Currículum",
    ...
    proj1_cta_analysis: "Ver análisis completo del proyecto",
  ...
  en: {
    ...
    exp1_b1: "Coordinate technical onboarding workflows and provide ongoing user support, working directly with management teams in the United States in English, Portuguese, and Spanish.",
    exp1_b2: "Lead three weekly cross-functional group sessions, coordinating different teams and adapting communication to varying user needs.",
    exp1_b3: "Manage the full tracking and documentation cycle for onboarding cohorts: progress logs, execution plans, mentoring summaries, and CRM data.",
    exp1_b4: "Identify recurring workflow and communication issues, developing proactive documentation and FAQs that contributed to a 20% improvement in onboarding accuracy and delivery.",
    exp1_b5: "Resolve user and workflow issues, quickly adapting to changes in software, processes, and operational priorities.",
    ...
    exp2_b5: "Deploy and maintain a self-hosted automation environment on Ubuntu/DigitalOcean using Docker, Caddy, Cloudflare DNS, and automated SSL.",
    ...
    proj1_cta_analysis: "View full project case study",
  ...
  pt: {
    ...
    exp1_role: "Technical Support & Onboarding Specialist",
    exp1_org: "Missionary Training Center USA (MTC) — remoto",
    exp1_b1: "Coordeno fluxos de onboarding técnico e ofereço suporte contínuo aos usuários, trabalhando diretamente com equipes de gestão nos Estados Unidos em inglês, português e espanhol.",
    exp1_b2: "Lidero três sessões semanais multifuncionais em grupo, coordenando diferentes equipes e adaptando a comunicação a diferentes necessidades dos usuários.",
    exp1_b3: "Gerencio o ciclo completo de acompanhamento e documentação das turmas de onboarding: registros de progresso, planos de execução, resumos de mentoria e dados de CRM.",
    exp1_b4: "Identifico problemas recorrentes de fluxo e comunicação e desenvolvo documentação e FAQs proativas, contribuindo para uma melhora de 20% na precisão e entrega do onboarding.",
    exp1_b5: "Resolvo problemas de usuários e de fluxo de trabalho, adaptando-me rapidamente a mudanças em software, processos e prioridades operacionais.",
    exp2_date: "2026 — Atual",
    exp2_role: "Founder & Automation Engineer — International E-commerce & Import Operations",
    exp2_org: "Repuestolandia",
    exp2_b1: "Construo um empreendimento internacional de importação e e-commerce de autopeças, projetado para automatizar de ponta a ponta o abastecimento de produtos vindos do Brasil e sua venda no Chile.",
    exp2_b2: "Desenhei e implementei fluxos de trabalho automatizados que conectam fornecedores, dados de produtos, estoque, preços e Shopify usando n8n, REST APIs, Google Sheets, ferramentas de IA e infraestrutura em nuvem.",
    exp2_b3: "Construí automações para ingestão, classificação, tradução, precificação, publicação e verificação de estoque de produtos, integrando regras de negócio com fontes de dados externas.",
    exp2_b4: "Desenvolvi verificação automática de estoque acionada por novos pedidos, para evitar overselling e melhorar a confiabilidade dos pedidos.",
    exp2_b5: "Implanto e mantenho um ambiente de automação auto-hospedado em Ubuntu/DigitalOcean usando Docker, Caddy, Cloudflare DNS e SSL automatizado.",
    exp2_b6: "Integrei a API Admin da Shopify e resolvi problemas de autenticação, permissões, dependências de dados e execução de fluxos, aprendendo e implementando novas tecnologias de forma independente.",
    exp3_date: "Jun. 2024 — Set. 2024",
    exp3_role: "Premium Guest Service Specialist / Trilingual Guest Relations",
    exp3_org: "Valle Nevado Ski Resort, Chile",
    exp3_b1: "Atendi hóspedes internacionais em inglês e português, além do espanhol, resolvendo solicitações de serviço e problemas de comunicação em um ambiente de ritmo acelerado.",
    exp3_b2: "Gerenciei múltiplas prioridades simultâneas mantendo atenção aos detalhes, profissionalismo e conformidade com os procedimentos operacionais e de segurança.",
    exp3_b3: "Adaptei-me rapidamente às necessidades variáveis dos hóspedes e a requisitos operacionais sensíveis ao tempo.",
    exp4_date: "Fev. 2023 — Abr. 2024",
    exp4_role: "Executive Assistant to Regional Director",
    exp4_org: "International Volunteer Operations, Santos, Brasil",
    exp4_b1: "Fui o principal elo operacional e multilíngue de um diretor regional, coordenando comunicações, logística, documentação e processos organizacionais em um ambiente internacional.",
    exp4_b2: "Gerenciei estruturas de apoio, recursos e logística operacional para uma comunidade multicultural de mais de 150 voluntários internacionais.",
    exp4_b3: "Atuei como principal ponto de contato para resolver gargalos linguísticos, operacionais e de fluxo de trabalho, apoiando a adoção de procedimentos organizacionais.",
    exp4_b4: "Realizei auditorias diárias de alto volume sobre informações de desempenho e conformidade, mantendo precisão e alinhamento com os padrões da organização.",
    exp4_b5: "Coordenei a comunicação entre stakeholders de múltiplos países e origens culturais, exigindo forte priorização, organização e resolução de problemas.",
    cv_title: "Currículo",
    ...
    proj1_cta_analysis: "Ver estudo de caso completo",
    proj1_cta: "Ver loja",
  ...
  fr: {
    ...
    exp1_b5: "Résous les problèmes des utilisateurs et de flux de travail, en m'adaptant rapidement aux changements de logiciels, de processus et de priorités opérationnelles.",
    ...
    exp2_b2: "J'ai conçu et mis en place des flux de travail automatisés reliant fournisseurs, données produits, inventaire, tarification et Shopify à l'aide de n8n, d'API REST, de Google Sheets, d'outils d'IA et d'une infrastructure cloud.",
    exp2_b3: "J'ai construit des automatisations pour l'ingestion, la classification, la traduction, la tarification, la publication et la vérification des stocks de produits, en intégrant des règles métier à des sources de données externes.",
    exp2_b4: "J'ai développé une vérification automatique des stocks déclenchée par les nouvelles commandes afin d'éviter les surventes et d'améliorer la fiabilité des commandes.",
    exp2_b5: "Déploie et maintiens un environnement d'automatisation auto-hébergé sur Ubuntu/DigitalOcean avec Docker, Caddy, Cloudflare DNS et un SSL automatisé.",
    exp2_b6: "J'ai intégré l'API Admin de Shopify et résolu des problèmes d'authentification, de permissions, de dépendances de données et d'exécution des flux, en apprenant et en mettant en œuvre de nouvelles technologies de façon autonome.",
    exp3_date: "Juin 2024 — Sept. 2024",
    exp3_role: "Premium Guest Service Specialist / Trilingual Guest Relations",
    exp3_org: "Valle Nevado Ski Resort, Chile",
    exp3_b1: "J'ai accueilli des clients internationaux en anglais et en portugais en plus de l'espagnol, en résolvant des demandes de service et des problèmes de communication dans un environnement au rythme soutenu.",
    exp3_b2: "J'ai géré plusieurs priorités simultanées tout en maintenant le souci du détail, le professionnalisme et le respect des procédures opérationnelles et de sécurité.",
    exp3_b3: "Je me suis rapidement adapté aux besoins changeants des clients et à des exigences opérationnelles sensibles au facteur temps.",
    exp4_date: "Févr. 2023 — Avr. 2024",
    exp4_role: "Executive Assistant to Regional Director",
    exp4_org: "International Volunteer Operations, Santos, Brasil",
    exp4_b1: "J'ai été le principal point de liaison opérationnel et multilingue d'un directeur régional, coordonnant les communications, la logistique, la documentation et les processus organisationnels dans un cadre international.",
    exp4_b2: "J'ai géré les structures de soutien, les ressources et la logistique opérationnelle pour une communauté multiculturelle de plus de 150 volontaires internationaux.",
    exp4_b3: "J'ai été le principal point de contact pour résoudre les blocages linguistiques, opérationnels et de flux de travail, en soutenant l'adoption des procédures organisationnelles.",
    exp4_b4: "J'ai réalisé des audits quotidiens à fort volume sur les données de performance et de conformité, en maintenant précision et cohérence avec les standards de l'organisation.",
    exp4_b5: "J'ai coordonné la communication entre des parties prenantes de plusieurs pays et cultures, exigeant une forte capacité de priorisation, d'organisation et de résolution de problèmes.",
    cv_title: "CV",
    ...
    proj1_cta_analysis: "Voir l'étude de cas complète",
